...
export default {
  ...
  SIGNIN_HEADING: 'Continue With NUT',
  SIGNIN_SUBHEADING: 'To use NUT you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using NUT, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use Nut a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
